...
class FaceRecog():
    ...
    def get_frame(self):
        ...
        # Get FaceLocation in Frame
        self.face_locations = face_recognition.face_locations(self.rgb_small_frame,number_of_times_to_upsample=2)
        
        #if self.process_this_frame:
        if self.currenttimer>30:
            # Find all the faces and face encodings in the current frame of video
            
            #t=threading.Thread(target=MyThread,args=(self,))
            #t.start()
            
            self.face_encodings = face_recognition.face_encodings(self.rgb_small_frame, self.face_locations,num_jitters=0)
